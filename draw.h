...
void draw(){
	...
	for(i = 0; i < 6; i++){
		if(turn % 2 != 0){
			...
			switch(i){
				case 0:  //"000000000011111111112222222222333333333344/\4444445555555555666666666677777777778888888888999999"
					printf("                                                                                                ");

					break;

				case 1:  //"000000000011111111112222222222333333333344/\4444445555555555666666666677777777778888888888999999"
					printf("    ████                            矢印キー: 選択する                                          ");

					break;

				case 2:  //"000000000011111111112222222222333333333344/\4444445555555555666666666677777777778888888888999999"  
					printf("  ████████                      エンターキー: 石を打つ                                          ");

					break;

				case 3:  //"000000000011111111112222222222333333333344/\4444445555555555666666666677777777778888888888999999"
					printf("  ████████                 バックスペースキー: ゲームを終了する                                 ");

					break;

				case 4:  //"000000000011111111112222222222333333333344/\4444445555555555666666666677777777778888888888999999"
					printf("    ████                                                                                        ");

					break;

				case 5:  //"000000000011111111112222222222333333333344/\4444445555555555666666666677777777778888888888999999"
					printf("                                                                                                ");
